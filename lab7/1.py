...
w , h = screen.get_size()
bg = pygame.transform.scale(get_image("C:/GitPython/PP2/lab7/img/mainclock.png"), (w,h))
...
while not done :
    ...
    blitRotate(screen , get_image("C:/GitPython/PP2/lab7/img/leftarm.png") , pos ,angle_sec )
    blitRotate(screen , get_image("C:/GitPython/PP2/lab7/img/rightarm.png"), pos , angle_min)
